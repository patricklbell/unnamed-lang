...
//     case Type::PrimitiveTypes::Float:
//       return llvm::Type::getFloatTy(*llvm_context);
//     case Type::PrimitiveTypes::Int:
//       return llvm::Type::getInt64Ty(*llvm_context);
//     case Type::PrimitiveTypes::Struct:
//       LANG_ASSERT("@todo");
//     case Type::PrimitiveTypes::Unknown:
//       LANG_ASSERT(false);
//   }
...
//   LANG_ASSERT(node.type == ASTNodeType::FunctionDeclaration);
//   ASTFunctionDeclarationData* data = node.cast_data<ASTFunctionDeclarationData>();

//   int id = node.id + 1;

//   if (data->is_generic) {
//     LANG_ASSERT(!data->is_generic, "@todo");
//     static_assert((int)FunctionDefinitionChildren::ParameterDefinitionList == 1);
//     ASTNode& parameter_definition_list = ctx.ast->nodes[id];
//     id += parameter_definition_list.size;
//   }
...
//     ASTNode& type_node = ctx.ast->nodes[id];
//     id += type_node.size;

//     Type* type = type_node.cast_data<ASTType>()->resolved_type;
//     LANG_ASSERT(type != nullptr, "unresolved type encountered during codegen");
...
//   switch (data->resolved_type->primitive) {
//     case Type::PrimitiveTypes::Float:
...
//   switch (LHS_resolved_type->primitive) {
//     case Type::PrimitiveTypes::Float:
//     {
//       switch (data->op) {
...
//   switch (exp_resolved_type->primitive) {
//     case Type::PrimitiveTypes::Float:
//     {
//       switch (data->op) {
